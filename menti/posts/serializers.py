...
class PostSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Post
        fields = ['id','title', 'content','is_published', 'slug', 'tags','updated_at','author','created_at','categories']
        read_only_fields = ['id', 'created_at','updated_at','author']  # эти поля нельзя менять через API